...
#define MQTT_USER               "KJBewfkjsdfiu_kauehfmd"
#define MQTT_PASSWORD           "UIhefuhjdIUuhfkj_kajehfu"
#define MQTT_PUBLISH_TOPIC    "lestari/pic1"
#define MQTT_SUBSCRIBE_TOPIC    "lestari/pic1"
