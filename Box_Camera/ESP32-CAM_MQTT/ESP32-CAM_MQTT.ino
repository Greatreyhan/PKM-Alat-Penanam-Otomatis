...
#include <DHT.h> 
#define DHTPIN 20 // The data pin of DHT11/DHT22 should be connected to the digtal pin 9 of Arduino.   
...
#define MQTT_PUBLISH_TOPIC    "lestari/pic2"
#define MQTT_SUBSCRIBE_TOPIC    "lestari/pic2"
